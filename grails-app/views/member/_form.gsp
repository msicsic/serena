...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'number', 'error')} required">
	<label for="number">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'address2', 'error')} ">
	<label for="address2">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'postalCode', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'town', 'error')} required">
	<label for="town">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'dept', 'error')} required">
	<label for="dept">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'tel', 'error')} ">
	<label for="tel">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'dmPresent', 'error')} ">
	<label for="dmPresent">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'cancelled', 'error')} ">
	<label for="cancelled">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'dead', 'error')} ">
	<label for="dead">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'vision', 'error')} ">
	<label for="vision">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'hearing', 'error')} ">
	<label for="hearing">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'mobility', 'error')} ">
	<label for="mobility">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'understanding', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'pathologies', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'treatments', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'doctorFirstname', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'doctorLastname', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'doctorPhone', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'doctorPhoneNight', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'doctorPhoneMobile', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'doctorFax', 'error')} ">
	<label for="doctorFax">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'doctorEmail', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: memberInstance, field: 'doctorInfo', 'error')} ">
